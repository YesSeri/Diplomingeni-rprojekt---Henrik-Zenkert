...
There is no hard divide between software development and operating the software, Dev-ops. Teams are expected to handle both for their applications. 
...
It was difficult, because the codebase is enormous, over 200.000 LOC(Lines Of Code). One person at work knows it well, but even he admits that there are parts of the code he has never seen, and even less understands.
