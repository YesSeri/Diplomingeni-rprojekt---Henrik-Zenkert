...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.00\textwidth]{images/integration-test.pdf}
    \caption{Matching host's current system path (yellow), with the correct git commit and branch(blue)}
...
The most complex part of the system logic in the back end is matching 
