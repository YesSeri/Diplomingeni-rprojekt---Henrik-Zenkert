...
The proposed system is evaluated by comparing its reliability, security, and usability with the existing SSH-based setup. A successful solution will match the functionality of the current tooling while significantly improving security, data quality, and long-term operability.
